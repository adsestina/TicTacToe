...
class TicTacT {
    ...
    //Variable to hold X or O, whicever team user chooses
    public static char team = '_';
    
    // Variable to hold X or O, whichever team user does not choose!
    public static char opp = '_';
    
    //Variable to hold user imput for Scanner
    public static String usrStr;

    public static void main (String[] args) {
        
        //Greating message for user
    ...
    public static void game () {
        ...
        // Local varieble to run loop
        boolean loop = true;
        
        System.out.println("IT'S YOOUR TURN!");
